...
export default function NewQuotation() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!header.quotation_number.trim()) throw new Error('Quotation number is required');
      if (!header.quotation_date) throw new Error('Quotation date is required');
      ...
      const { error: itemInsertError } = await supabase.from('quotation_items').insert(
        cleanItems.map((li) => ({
    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Add a new quotation</p>
        </div>
      </div>
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FieldShell label="Quotation Date" required>
                <TextInput
                  ...
                  onChange={(e) => setHeader({ ...header, quotation_date: e.target.value })}
                />
              </FieldShell>
            ...
            <div className="flex space-x-2 pt-4 border-t border-gray-200">
              <button type="button" onClick={() => navigate('/sales/quotations')} className="px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-50">
                Cancel
              </button>
