-- Run this in Supabase Dashboard → SQL Editor (your production project).
-- Fixes: "could not find function public.get_public_sales_invoice"
--
-- Also ensures invoices have share tokens (qr_code) and the unique index.
